  ...
  return (
    <main className="p-10 max-w-7xl mx-auto">
      <header className="max-w-3xl mx-auto mb-20 text-center">
        ...
        <p className="text-xl text-gray-300 leading-relaxed dark:text-zinc-400">
        ...
        <div className="mt-10 flex flex-col items-center">
          ...
          <p className="text-lg uppercase tracking-[0.3em] font-bold mb-6 text-gray-400 dark:text-zinc-500">
            Projects
          </p>

          <p className="text-gray-200 mt-4 leading-relaxed mb-4 dark:text-zinc-100">This is a collection of projects that I have worked on over the years. Some are more recent than others, but all of them are a testament to my growth as a developer and designer.</p>
        </div>
      </header>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">

        {projects.map((project: getProjectsType, index: number) => (
          <div className="border border-gray-100 bg-white p-6 rounded-lg shadow-sm transition-all hover:shadow-md dark:border-zinc-800 dark:bg-zinc-900/50" key={project._id}>

            <Link href={`/projects/${project.slug}`} className="group">
              <h2 className="text-xl  mb-4 font-semibold group">{project.title}</h2>
            ...
            <a
              ...
              className="bg-blue-100 text-blue-800 font-bold text-sm px-2 py-1 rounded hover:bg-blue-500 hover:text-blue-100 transition-colors"
            >
